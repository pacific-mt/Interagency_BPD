...
function one(name,x,r,A){
  ...
  let egaText=ega===W[0] && x<A[0][3]
    ...
    : '≈ '+ega.toFixed(1)+' weeks'
;
  return '<div style="padding:10px 0;border-bottom:1px solid #ccc"><b>'+name+'</b><div style="font-size:25px;font-weight:bold">'+x.toFixed(1)+' mm</div><div><b>Centile: '+p.toFixed(1)+'th</b></div><div class="'+cl+'" style="margin-top:6px">'+s+'</div><div style="margin-top:8px"><b>Size-equivalent GA:</b> '+egaText+'</div><div class="small">10th: '+p10.toFixed(1)+' mm | 50th: '+p50.toFixed(1)+' mm | 90th: '+p90.toFixed(1)+' mm</div></div>';
}
